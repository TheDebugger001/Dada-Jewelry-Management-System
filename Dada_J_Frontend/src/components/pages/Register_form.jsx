    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      ...
      <div className='w-3/11 h-[38em] bg-white rounded-xl flex flex-col items-center justify-evenly shadow-lg shadow-black/30 relative'>
        ...
        <div className='w-full h-3/7 flex flex-col items-center justify-evenly'>
          ...
          <Link to="/admin_dashboard" className='w-4/5 h-1/6 rounded-lg flex items-center justify-center outline-none ring-1 ring-gray-600 bg-gray-600 text-white font-semibold hover:bg-gray-500 active:transform active:scale-95'>Register</Link>
        </div>
        ...
        <div className='w-full h-[1.5em] flex items-center justify-center relative -top-6'>
          <p>Already have an account?<button className='font-semibold text-gray-600 hover:text-gray-800 hover:underline transition duration-150'>Login</button>
          </p>
        </div>
      </div>
    </div>
